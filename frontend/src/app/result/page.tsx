        ...
        <Card className="w-full">
          ...
          <CardContent className="flex flex-col items-center space-y-6">
            <div className="flex flex-col items-center">
              {getTrashIcon()}
              <div className="mt-4 text-xl font-bold">{t(`result.${trashResult}`)}</div>
            </div>
            ...
            <Button className="bg-purple-600 hover:bg-purple-700 text-white" onClick={() => router.push("/calendar")}>
